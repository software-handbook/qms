...
function dropdown_menu_hack(el) {
    ...
    if (window.createPopup == null) {
        ...
        window.createPopup = function () {
            if (window.createPopup.frameWindow == null) {
                ...
                fwin.style.cssText = "position:absolute;top:0;left:0;display:none;z-index:99999;font-family:Arial, Tahoma, Helvetica, sans-serif;";
    ...
    function showMenu() {
        ...
        mb.style.cssText = "border:solid 1px black;margin:0;padding:0;overflow-y:auto;overflow-x:auto;background:white;text-aligbn:center;font-family:Courier New;font-size:11px;";
        ...
        for (var i = 0; i < mb.options.length; i++) {
            ...
            mb.options[i].onmouseover = function () {
                if (mb.options.selected) { mb.options.selected.style.background = "white"; mb.options.selected.style.color = "#003300"; }
                mb.options.selected = this;
                this.style.background = "#316AC5"; this.style.color = "white";
            }

            mb.options[i].onmouseout = function () { this.style.background = "white"; this.style.color = "#003300"; }
